...
my.dat$Religion <- factor(my.dat$Religion, 
                           levels = c("Christian", "No Religion", "Catholic", "Jehovah Witness", "Muslim", "Mormon", "Spiritualist", "Pagan", "Jewish", "Hindu", "Buddhist", "Agnostic","PNA","Buddhism","Catholicism","No Religion","Islam","Christianity","Taoism","Hinduism"),
                           labels = c("Christian", "No Religion", "Catholic", "Jehovah Witness", "Muslim", "Mormon", "Spiritualist", "Pagan", "Jewish", "Hindu", "Majority", "Underrepresented","Underrepresented","Underrepresented","Underrepresented","No Religion","Islam","Christianity","Taoism","Hinduism"))
...
test.data = filtered.dat[,c('Age','Income','Housing','Gender','Education','Employment','Religion','Ethnicity',
                            'Siblings','Marital')]
